...
public class StudentDB implements StudentDAO{
    ...
    public boolean insertStudent(Student student) {
        try {
            ...
            ps.setString(8,student.getStudentNum());
    ...
    private Student extractStudentFromResultSet(ResultSet resultSet) throws SQLException {
        ...
        return new Student(studentID,studentNum,name,surname,email,idNumber,address,password,studentNum,cdao.getCourse(courseID));
    }
