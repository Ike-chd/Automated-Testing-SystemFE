        ...
        <div class="grid-container">
                ...
                <ul class="sidebar-list">
                    ...
                    <li class="sidebar-list-item">
                        <a href="allStudents.html">
                            <span class="material-icons-outlined">people</span> Students
                        </a>
                    </li>
                    <li class="sidebar-list-item">
                    ...
                    <li class="sidebar-list-item">
                        <a href="#">
                            <span class="material-icons-outlined">assignment</span> Assignments
                        </a>
                    </li>
                    <li class="sidebar-list-item">
                        <a href="#">
            ...
            <main class="main-container">
                ...
                <div class="main-cards">
                    ...
                    <div class="card">
                        <div class="card-inner">
                            <p class="text-primary">ENROLLMENTS</p>
                            <span class="material-icons-outlined text-green">event_note</span>
                        </div>
                        <span class="text-primary font-weight-bold">Pending: XXX</span>
                    </div>

                    <div class="card">
                        <div class="card-inner">
                            <p class="text-primary">GRADES</p>
